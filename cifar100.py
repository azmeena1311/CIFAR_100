...
dg = datagen.flow(x_test, y_test, batch_size=batch_size)
predict_gen = model.predict_generator(dg, steps=x_test.shape[0] // batch_size)
test_validations.append(evaluate_generator)
